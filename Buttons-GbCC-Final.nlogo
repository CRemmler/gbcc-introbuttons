...
;; wait .2  ;; not support in NetLogoWeb
]
end
...
to startup
  set welcome-teacher "Please create a room."
  set welcome-student "Please choose a room."
end
...
to run-code
  gbcc-run-code code-example
end

to share-code
  hubnet-send "server" "code-example" code-example
  gbcc-send-canvas
end
